...
start /b "" python "C:\xampp\htdocs\EPI-original-trabalho-master_camerasAtuais\EPI-original-trabalho-bia\senaiEpi_Ia\servidor_camera.py"

echo Iniciando Servidor Facial (Porta 5001)...
start /b "" python"C:\xampp\htdocs\EPI-original-trabalho-master_camerasAtuais\EPI-original-trabalho-bia\senaiEpi_Ia\Trabalho-E.P.I\reconhecimento_facial\sistema_final.py"
